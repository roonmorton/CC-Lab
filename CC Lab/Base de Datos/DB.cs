...
namespace CC_Lab
{
    class DB
    {
        private static String cadenaConexion = @"Data Source=SOPORTE-PC\SQLEXPRESS;Initial Catalog=DBLAB;Integrated Security=True";
        ...
        public DataTable ejecutarSPdt(string spNombre, SqlConnection cn = null, params SqlParameter[] arrParam)
        {
